...
public class Main extends javax.swing.JFrame {
    private Jackpot jackpot = new Jackpot("historial.xml");
    ...
    private void mostrarCombinaciones() {
        System.out.println(jackpot.getCombinacionList());
    }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        int respuesta = JOptionPane.showConfirmDialog(this, "¿Desea apagar la máquina?", "Apagando", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
        if (respuesta == JOptionPane.OK_OPTION) {
            jackpot.exportarHistorialXML();
            this.dispose();
        } else {
            ArrayList<HistorialJackpot> listaHistorial = jackpot.getListaHistorial();
            DateFormat formato = DateFormat.getDateTimeInstance();
            for (HistorialJackpot h : listaHistorial) {
                System.out.print(formato.format(h.getCalendar().getTime())+" ");
                System.out.print(" "+h.getSaldo());
                System.out.print(" "+h.getDeposito());
                System.out.print(" "+h.getPremio());
                System.out.println(" "+h.getCombinacion()[0]+h.getCombinacion()[1]+h.getCombinacion()[2]);                
            }
        }
